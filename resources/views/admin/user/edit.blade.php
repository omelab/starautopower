    ...
    <div class="row-fluid">
        <div class="box span12">
            ...
            <div class="box-content">
                {!! Form::open(['route'=>['admin.update-users', $admin->id], 'enctype' => 'multipart/form-data', 'class'=>'form-horizontal']) !!} 
                <fieldset>

                    <div class="control-group {{ $errors->has('name') ? 'has-error' : '' }}">
                        {!! Form::label('name', 'Name :', array('class' => 'control-label')) !!}                      
                        <div class="controls">
                          {!! Form::text('name', $admin->name??old('name'), ['class'=>'input-xlarge', 'placeholder'=>'Enter Name']) !!}
                    ...
                    <div class="control-group {{ $errors->has('email') ? 'has-error' : '' }}">
                        ...
                        <div class="controls">
                          {!! Form::text('email', $admin->email??old('email'), ['class'=>'input-xlarge', 'placeholder'=>'info@yourmail.com']) !!}
