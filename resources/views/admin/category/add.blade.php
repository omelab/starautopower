...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			{!! Form::open(['route'=>'admin.add-category.submit', 'enctype' => 'multipart/form-data', 'class'=>'form-horizontal']) !!}
				...
				<fieldset>
					...
					<div class="control-group {{ $errors->has('parent_id') ? 'has-error' : '' }}">						
						...
						<div class="controls">
							{!! Form::select('parent_id', $allCategories, old('parent_id'), ['class'=>'form-control', 'data-rel'=>'chosen', 'placeholder'=>'Select Category']) !!}
					...
					<div class="control-group {{ $errors->has('position') ? 'has-error' : '' }}">
						...
						<div class="controls">
						  {!! Form::number('position', old('position'), ['class'=>'input-xlarge', 'placeholder'=>'Enter Display Position']) !!}
