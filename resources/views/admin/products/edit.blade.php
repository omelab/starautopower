...
<ul class="breadcrumb">
    ...
    <li>
        <a href="{{ route('admin.add-products') }}">Add New Product</a>
    </li>
</ul>
                ...
                <fieldset>
                    ...
                    <div class="control-group {{ $errors->has('image') ? 'has-error' : '' }}">
                        ...
                        <div class="old-cat-img">
                            <img src="{{URL::to('images/' . $product->image)}}" alt="{{$product->title }}" srcset="{{URL::to('images/' . $product->image)}} 2x" width="50">
                        </div>  
                            ...
                            <div id="galleryimg" class="gallery-images">
                                ...
                                @foreach($product->images as $pimage)
                                    <div class="pro-img">
                                        ...
                                        <img src="{{URL::to('images/' . $pimage->filename)}}" srcset="{{URL::to('images/' . $pimage->filename)}} 2x" alt="{{$product->title }}" width="70">
                                    </div>  
                                @endforeach
                    ...
                    <table class="options-table">
                        ...
                        <tbody id="resdata">
                            ...
                            <tr>                                        
                                ...
                                <td><img src="{{URL::to('images/' . $option->images)}}" srcset="{{URL::to('images/' .$option->images)}} 2x" width="70"></td>
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $.each(result, function(i){
                            ...
                            /*<form action="{{URL::to('options')}}/'+ result[i].id +'" method="POST"> @csrf @method('DELETE') <button class="btn btn-danger"><i class="halflings-icon trash white"></i> Delete</button></form>*/  
                        });
